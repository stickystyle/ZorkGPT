...
class StructuredZorkParser:
    ...
    def extract_score_and_moves(self, zork_response: str) -> Tuple[Optional[int], Optional[int]]:
        """
...
def test_parser():
    ...
    for i, test_case in enumerate(test_cases):
        ...
        print(f"Canonical room: {parser.get_canonical_room_name(result.room_name) if result.room_name else 'None'}")
