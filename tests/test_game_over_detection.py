...
The troll swings his axe, but it misses."""
        ...
        self.assertFalse(is_over, f"Troll miss should not be game over. Reason: {reason}")
    ...
    def test_combat_messages_not_game_over(self):
        ...
        for msg in combat_messages:
            with self.subTest(message=msg):
                ...
                self.assertFalse(is_over, f"Combat message should not be game over: '{msg}'. Reason: {reason}")
