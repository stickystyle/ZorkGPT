...
class TestActionRejectionSystem:
    ...
    def test_novel_action_in_current_location(self):
        ...
        context = {
            ...
            "recent_actions": ["go north", "go south", "look", "go north", "go south", "look"],
            "previous_actions_and_responses": [
    ...
    def test_loop_detection_with_location_specific_failures(self):
        ...
        context = {
            ...
            "recent_actions": ["go north", "go north", "go north", "look", "go north", "look"],
            "previous_actions_and_responses": [
                ("go north", "There is a wall there."),
                ("go north", "There is a wall there."), 
                ("go north", "There is a wall there."),
        ...
        assert should_override
        assert any(word in reason for word in ["loop", "diversity", "progress", "novel_action"])
...
class TestFailureDetection:
    ...
    def setup_method(self):
        ...
        with patch('zork_critic.get_config') as mock_config, \
    ...
    def test_detect_parser_failure(self):
        ...
        mock_response = Mock()
        mock_response.content = '{"action_failed": true, "reason": "Parser did not understand the command"}'
        ...
        assert "parser" in result.reason.lower() or "understand" in result.reason.lower()
    ...
    def test_detect_blocked_movement(self):
        ...
        # Mock LLM response indicating failure
        mock_response = Mock()
        mock_response.content = '{"action_failed": true, "reason": "Movement blocked by wall"}'
    ...
    def test_detect_successful_action(self):
        ...
        mock_response = Mock()
        mock_response.content = '{"action_failed": false, "reason": "Action succeeded - item was taken"}'
